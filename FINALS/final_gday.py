'''module that provides functions to program'''
from tkinter import PhotoImage, Label, Frame, Entry, Button, LabelFrame, Checkbutton, Tk, CENTER, W
...
welcome = Label(register_frame,
                text="Good Morning! \nWelcome to \"G\'DAY\" your morning routine app.",
                background="#FFDE59")
...
def record_name():
    ...
    write_name = open("/Users/andzilem/2023CODE/FINALS/TEXT_FILES/writing_name.txt",
                      "w",
                      encoding= 'utf-8')
...
info = Label(limit_frame,
             text="Enter item names seperated by commas. \n Must input exaclty 10 routine items.",
             background="#FFDE59")
info.grid(row=0, column=0)

def record_list():
    '''function to write the users routine list'''
    write_list = open("/Users/andzilem/2023CODE/FINALS/TEXT_FILES/writing_list.txt",
             "w",
            encoding= 'utf-8')
    write_list.write(item_list.get())
    write_list.close()
    second_page.destroy()
...
day_frame = ttk.Frame(third_page)
day_frame.place(relx=0.65, rely=0.1, anchor=CENTER)

#reading file for users name
read_name = open("/Users/andzilem/2023CODE/FINALS/TEXT_FILES/writing_name.txt",
         "r",
        encoding= 'utf-8')

weekday = ttk.Label(day_frame,
                    text="G'Day to you " + read_name.read() +
...
get_list = open(file="/Users/andzilem/2023CODE/FINALS/TEXT_FILES/writing_list.txt",
                mode = "r",
                encoding= 'utf-8')

#hold list into a list variable and split using commas for seperating into checkbuttons
routine_list =get_list.read().split(",")

#users final routine as checkbuttons
check1 = Checkbutton(third_page,
                     text= routine_list[0],
                     onvalue=1,
                     offvalue=0,
                     background="#FFDE59")
...
check10 = Checkbutton(third_page,
                      text = routine_list[9],
                      onvalue = 1,
                      offvalue = 0,
                      background="#FFDE59")
...
def destroy():
    '''function that destroys the program'''
    get_list.close()
    third_page.destroy()

#button to destroy page
close_button = Button(third_page, text="Finish Routine",command= destroy)
